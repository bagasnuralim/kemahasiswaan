...
<!-- <div id="container">
	<h1 align="center">DIREKTORAT KEMAHASISWAAN STIE INABA</h1>

	<div id="body">
		<h3>Pusat data & informasi</h3>
		<p>body pusat data & informasi </p>
	</div>
	<div id="body">
		<h3>Agenda</h3>
		<p>body Agenda</p>
          ...
          <div class="col px-0">
            <div class="row align-items-center justify-content-center">
              <div class="col-lg-6 text-center">
                <img src="<?= base_url('assets/img/brand/logo-inaba.png');?>" style="width: 200px;" class="img-fluid">
                <p class="lead text-white">Menjadi Sekolah Tinggi Ilmu Ekonomi yang unggul pada bidang akuntansi, manajemen dan kewirausahaan.</p>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-12">
            <!-- Basic elements -->
            <h2 class="mb-5">
              <span>Pusat data & Informasi</span>
            </h2>
